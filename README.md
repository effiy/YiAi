...
[项目概述](#-项目概述) | [技术栈](#-技术栈) | [快速开始](#-快速开始) | [文档](#-文档) | [架构](#-架构) | [关键命令](#-关键命令) | [故障排除](#-故障排除) | [更新日志](#-更新日志) | [更多信息](#-更多信息)
...
| 对象存储 | 阿里云 OSS (oss2) | 阿里云对象存储服务 SDK |
| 配置管理 | Pydantic Settings + YAML | 类型安全的配置管理，支持环境变量覆盖 |
