...
[项目概述](#-项目概述) | [技术栈](#-技术栈) | [配置指南](#-配置指南) | [快速开始](#-快速开始) | [核心功能](#-核心功能) | [架构设计](#-架构设计) | [数据库集合](#-数据库集合) | [API 端点](#-api-端点) | [项目结构](#-项目结构) | [开发规范](#-开发规范)
...
| ☁️ 对象存储 | 阿里云 OSS (oss2) | 阿里云对象存储服务 SDK |
| ⚙️ 配置管理 | Pydantic Settings + YAML | 类型安全的配置管理，支持环境变量覆盖 |
