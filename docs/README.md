...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><a href="./01_核心功能/11_AI聊天/多轮对话.md">多轮对话</a></td>
      <td>集成 Ollama 本地 AI 模型，支持上下文感知的多轮对话</td>
    </tr>
    <tr>
      <td><a href="./01_核心功能/11_AI聊天/历史记录.md">历史记录</a></td>
      <td>自动保存聊天会话和消息记录，支持随时回溯</td>
    </tr>
    <tr>
      <td rowspan="2">📰 RSS 管理</td>
      <td><a href="./01_核心功能/12_RSS管理/定时抓取.md">定时抓取</a></td>
      <td>基于 APScheduler 的自动定时 RSS 源内容抓取</td>
    </tr>
    <tr>
      <td><a href="./01_核心功能/12_RSS管理/多源管理.md">多源管理</a></td>
      <td>支持配置多个 RSS 源，统一存储和管理文章内容</td>
    </tr>
    <tr>
      <td rowspan="3">📤 文件存储</td>
      <td><a href="./01_核心功能/13_文件存储/双重存储.md">双重存储</a></td>
      <td>支持阿里云 OSS 和本地静态文件存储两种方案，自动 fallback</td>
    </tr>
    <tr>
      <td><a href="./01_核心功能/13_文件存储/文件管理.md">文件管理</a></td>
      <td>提供文件上传、读取、写入、删除、重命名等完整操作</td>
    </tr>
    <tr>
      <td><a href="./01_核心功能/13_文件存储/图片清理.md">图片清理</a></td>
      <td>自动扫描并清理未被引用的图片文件，释放存储空间</td>
    </tr>
    <tr>
      <td rowspan="3">⚡ 动态执行</td>
      <td><a href="./01_核心功能/14_动态执行/模块执行引擎.md">模块执行引擎</a></td>
      <td>通过 REST API 动态执行 Python 模块方法，支持同步/异步函数</td>
    </tr>
    <tr>
      <td><a href="./01_核心功能/14_动态执行/SSE流式传输.md">SSE 流式传输</a></td>
      <td>为生成器函数提供 Server-Sent Events 流式响应</td>
    </tr>
    <tr>
      <td><a href="./01_核心功能/14_动态执行/白名单控制.md">白名单控制</a></td>
      <td>通过配置白名单限制可执行的模块，确保安全性</td>
    </tr>
    <tr>
      <td rowspan="2">🛡️ 安全认证</td>
      <td><a href="./01_核心功能/15_安全认证/令牌认证.md">令牌认证</a></td>
      <td>可选的 X-Token 认证中间件，保护 API 端点</td>
    </tr>
    <tr>
      <td><a href="./01_核心功能/15_安全认证/异常处理.md">异常处理</a></td>
      <td>统一的异常处理机制，标准化错误响应格式</td>
    </tr>
    <tr>
      <td>🏢 企业集成</td>
      <td><a href="./01_核心功能/16_企业集成/企业微信.md">企业微信</a></td>
