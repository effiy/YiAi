...
export default {
  ...
  speaker: {
    ...
    // 小米 ID
    userId: "3043068322", // 注意：不是手机号或邮箱，请在「个人信息」-「小米 ID」查看
    // 账号密码
    password: "Yi19911024",
    // 小爱音箱 DID 或在米家中设置的名称
    did: "Xiaomi 智能音箱 Pro", // 注意空格、大小写和错别字（音响 👉 音箱）
    ...
    callAIKeywords: ["请", "你", "悠宝"],
    // 当消息以下面的关键词开头时，会进入 AI 唤醒状态
    wakeUpKeywords: ["打开", "进入", "召唤"],
    // 当消息以下面的关键词开头时，会退出 AI 唤醒状态
    exitKeywords: ["关闭", "退出", "再见"],
    // 进入 AI 模式的欢迎语
    onEnterAI: ["你好，我是悠宝，很高兴认识你"], // 设为空数组时可关闭提示语
    // 退出 AI 模式的提示语
    onExitAI: ["悠宝已退出"], // 为空时可关闭提示语
    // AI 开始回答时的提示语
